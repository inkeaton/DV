...
This project explores 35 years of data visualization research using interactive web-based storytelling. The codebase is fully open and reproducible, with all preprocessing and data transformation steps documented in Jupyter notebooks.

---

## 1. Data Preprocessing Pipeline

All preprocessing scripts are in the `scripts/` folder and are Jupyter notebooks. Run them in order for full reproducibility:
...
You can use the [Live Server](https://marketplace.visualstudio.com/items?itemName=ritwickdey.LiveServer) extension to serve the `site/` folder.

---

## 3. Folder Structure & Data Locations
...
To run preprocessing notebooks, install dependencies:
